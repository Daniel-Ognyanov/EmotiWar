...
@Controller
public class SilverSetController {

    private final UserService userService;
    private final EmotiService emotiService;
    private final ItemService itemService;

    public SilverSetController(UserService userService, EmotiService emotiService, ItemService itemService) {
        this.userService = userService;
        this.emotiService = emotiService;
        this.itemService = itemService;
    }

    @GetMapping("/shop/silverSet")
    ...
    @GetMapping ("/shop/silverSet/buy/weapon/{id}")
    public String buyWeaponByID(RedirectAttributes redirectAttributes, @PathVariable Long id) {
        ...
        return "redirect:/shop/silverSet";
    }



    @GetMapping ("/shop/silverSet/buy/shield/{id}")
    ...
    @GetMapping ("/shop/silverSet/buy/head/{id}")
    ...
    @GetMapping ("/shop/silverSet/buy/boots/{id}")
    ...
    @GetMapping ("/shop/silverSet/buy/trinkets/{id}")

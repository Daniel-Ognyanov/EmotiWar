...
import emotiWar.service.EmotiWarUserServiceImpl;
...
public class UserServiceImpl implements UserService {
    ...
    private final EmotiWarUserServiceImpl emotiWarUserServiceImpl;
    ...
    public UserServiceImpl(ModelMapper modelMapper, PasswordEncoder passwordEncoder,
                           ...
                           EmotiWarUserServiceImpl emotiWarUserServiceImpl, EmotiService emotiService, ItemRepository itemRepository) {
        this.modelMapper = modelMapper;
        this.passwordEncoder = passwordEncoder;
        this.userRoleRepository = userRoleRepository;
        this.userRepository = userRepository;
        this.emotiWarUserServiceImpl = emotiWarUserServiceImpl;
    ...
    public void loginUser(UserLoginServiceModel userServiceModel) {
        UserDetails principal = emotiWarUserServiceImpl.loadUserByUsername(userServiceModel.getUsername());
